...
namespace CryptoTracker
{
    class BinanceImport : GeneralImport
    {
        ...
        private string[] binanceColumnNamesValidation = new string[] { "Date", "Market", "Type", "Price", "Amount", "Total", "Fee", "Fee Coin" };
        ...
        public DataTable ImportBinanceTradeData(string filePath, IProgress<int> progress)
        {
            ...
            if (ValidateDataFormat(binanceColumnNamesValidation, excelData))
            {
